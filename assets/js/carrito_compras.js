...
if (typeof ProductCart === 'undefined') {
    ...
    function addToCartById(productId) {
        ...
        if (DEBUG_MODE) {
            console.warn('Product found:', product);
            console.warn('Quantity to add:', quantity);
        }
    ...
    function addToCart(product) {
        if (DEBUG_MODE) {
            console.warn('addToCart (legacy) called with:', product);
        }
    ...
    function viewProductDetails(productId, productTitle, productUrl) {
        if (DEBUG_MODE) {
            console.warn('viewProductDetails called with:', {
                productId: productId,
        ...
        if (productUrl && productUrl !== '#' && productUrl !== '') {
            ...
            cart.showNotification(`No se puede abrir el producto "${productTitle}" porque no tiene un enlace válido.`, 'warning');
        }
    }
