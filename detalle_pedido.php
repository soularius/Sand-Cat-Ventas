...
foreach ($items as $it) {
    ...
    if (empty($image_url)) {
        $image_url = Utils::env('WOOCOMMERCE_BASE_URL') . '/wp-content/uploads/woocommerce-placeholder.webp';
    }
                ...
                <div class="col-lg-4 col-md-12 mb-4">
                    ...
                    <div class="summary-panel mt-4">
                        <div class="panel-header bg-warning bg-custom d-flex justify-content-between">
                            ...
                            <a href="<?= Utils::env('WOOCOMMERCE_BASE_URL'); ?>/wp-admin/admin.php?page=wc-orders&action=edit&id=<?php echo htmlspecialchars((string)$order_id); ?>" class="text-white wp-eye-link" title="Ver en panel administrativo de WordPress" target="_blank">
