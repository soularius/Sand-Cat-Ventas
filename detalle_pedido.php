                ...
                <div class="col-lg-4 col-md-12 mb-4">
                    ...
                    <div class="summary-panel mt-4">
                        <div class="panel-header bg-warning bg-custom d-flex justify-content-between">
                            ...
                            <a href="<?= URL_WOOCOMMERCE; ?>/wp-admin/admin.php?page=wc-orders&action=edit&id=<?php echo htmlspecialchars((string)$order_id); ?>" class="text-white wp-eye-link" title="Ver en panel administrativo de WordPress" target="_blank">
