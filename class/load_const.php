...
define('MAIL_PORT', intval(DatabaseConfig::getConfigValue('MAIL_PORT')));
...
define('SERIE_NUMERO_FACTURA', intval(DatabaseConfig::getConfigValue('SERIE_NUMERO_FACTURA')));
define('TAX_RATE', intval(DatabaseConfig::getConfigValue('TAX_RATE')));
define('TELEFONO', DatabaseConfig::getConfigValue('TELEFONO'));
define('TIMEZONE', DatabaseConfig::getConfigValue('TIMEZONE'));
define('URL_WOOCOMMERCE', DatabaseConfig::getConfigValue('URL_WOOCOMMERCE'));
define('VENTAS_URL', DatabaseConfig::getConfigValue('VENTAS_URL'));
define('WOOCOMMERCE_ORDER_PATH', DatabaseConfig::getConfigValue('WOOCOMMERCE_ORDER_PATH'));
