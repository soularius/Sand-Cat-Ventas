...
$menu_items_f = [
    ...
    'datos_venta.php' => 'facturacion',
    'pros_venta.php' => 'facturacion',
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark shadow-sm" style="background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent1">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($active_menu_f == 'ventas') ? 'active fw-bold' : ''; ?> px-3 py-2 rounded-pill mx-1" 
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($active_menu_f == 'productos') ? 'active fw-bold' : ''; ?> px-3 py-2 rounded-pill mx-1" 
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($active_menu_f == 'usuarios') ? 'active fw-bold' : ''; ?> px-3 py-2 rounded-pill mx-1" 
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($active_menu_f == 'facturacion') ? 'active fw-bold' : ''; ?> px-3 py-2 rounded-pill mx-1" 
      ...
      <div class="navbar-nav">
        <div class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a class="dropdown-item text-danger" href="facturacion.php?logout=login3Et" title="Cerrar sesión">
